...
<div class="container" id="regContainer">
    <form action="register.php" method="post" id="registration-form" autocomplete="off">
        ...
        <div class="row">
            <div class="col-md-5" > <!-- START OF FIRST COLUMN -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" autofocus="true" name="username" id="reg-username" class="form-control" aria-describedby="usernameHelpBlock" minlength="5" required/>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="reg-email" class="form-control" aria-describedby="emailHelpBlock" required/>
                ...
                <div class="form-group">
                    ...
                    <select name="securityquestiontwo" id="reg-securityquestiontwo" class="form-control">
                        ...
                        <option value="Favorite_Singer" class="form-control">Who is your favorite singer?</option>
            ...
            <div class="col-md-7 ml-auto"> <!-- START OF SECOND COLUMN -->
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" class="form-control" name="fname" id="reg-fname" placeholder="Juan" required/>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="mname">Middle Name</label>
                        <input type="text" class="form-control" name="mname" id="reg-mname" placeholder="Dela" />
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-9">
                        <label for="lname">Last Name</label>
                        <input type="text" class="form-control" name="lname" id="reg-lname" placeholder="Cruz" required/>
                    </div>
                    <div class="form-group col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="reg-birthday" name="birthday" required/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="age">Age</label>
                            <input type="text" id="reg-age" name="age" class="form-control" readonly/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="reg-block" name="block" aria-describedby="blockHelpBlock" required/>
                        </div>
                        <div class="col-md-4">
                            <small id="streetHelpBlock" class="form-text text-muted">Street</small>
                            <input type="text" class="form-control" id="reg-street" name="street" aria-describedby="streetHelpBlock"  required/>
                        </div>
                        <div class="col-md-4">
                            <small id="subdivisionHelpBlock" class="form-text text-muted">Subdivision</small>
                            <input type="text" class="form-control" id="reg-subdivision" name="subdivision" aria-describedby="subdivisionHelpBlock" required/>
                        </div>
                    </div>
        ...
        <div class="row"> <!-- ROW FOR BUTTON -->
            ...
            <div class="col-md-7">
                <div class="form-group">
                    <button type="submit" id="reg-submit" name="submit" class="btn btn-primary form-control">Register</button>
                </div>
            </div>
